...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium content pipeline dashboard for agencies and their clients." },
      { name: "author", content: "Socialvert" },
      { property: "og:title", content: "Socialvert — Content Dashboard" },
      { property: "og:description", content: "Premium content pipeline dashboard for agencies and their clients." },
