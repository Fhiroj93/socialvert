...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  useEffect(() => { reportClientError(error, { boundary: "tanstack_root_error_component" }); }, [error]);
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Socialvert — Content Dashboard" },
      { name: "description", content: "Premium Social Media content pipeline Dashboard for agencies." },
      { name: "author", content: "Socialvert" },
      { property: "og:title", content: "Socialvert — Content Dashboard" },
      { property: "og:description", content: "Premium Social Media content pipeline Dashboard for agencies." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Socialvert — Content Dashboard" },
      { name: "twitter:description", content: "Premium Social Media content pipeline Dashboard for agencies." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;0,9..144,700;1,9..144,500;1,9..144,600&display=swap" },
    ],
  }),
